...
let gwe = await client.prepareMessageFromContent(from, {
					

"buttonsMessage": {
					

"contentText": `Hai Pilih Salah Satu`,
					

"footerText": "ButtonsMessage By @amelCans",
...
case 'hilih':
            ...
            break
              ...
              case 'tebakgambar':
				...
				setTimeout( () => {
				client.sendMessage(from, '_10 Detik lagi..._', text, {quoted: mek})
				}, 20000)
				setTimeout( () => {
				client.sendMessage(from, '_20 Detik lagi..._', text, {quoted: mek})
				}, 10000)
				
				setTimeout( () => {
				client.sendMessage(from, '_30 Detik lagi..._', text, {quoted: mek})
				}, 2500)
				setTimeout( () => {
				client.sendMessage(from, hiya, MessageType.image, { caption: '_Tebak bro!!! gak bisa jawab donasi ya:v_', quoted: mek })
				}, 0)
				break
				case 'tebakbendera':
				...
				setTimeout( () => {
				client.sendMessage(from, hiya, text, { quoted: mek })
				}, 0)
				break
				case 'tebakangka':
            ...
            case 'ukty':
					...
					client.sendMessage(from, wkwk, video, { mimetype: 'video/mp4', quoted: mek })
					break
					case 'hijab':
					...
					wkwk = await getBuffer(wk.result.url)
					client.sendMessage(from, wkwk, MessageType.image, { quoted: mek })
					break
					case 'rika':
            ...
            case 'sider':
				...
				case 'stickernowm':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(`Kirim gambar dengan caption ${prefix2}stickernowm atau tag gambar yang sudah dikirim`)
					}
					break
					case 'indo1':
				...
				if (resbutton == 'menu') {
 	oyh = `ea`
client.sendMessage(from, oyh, text, {quoted: mek})			
}
