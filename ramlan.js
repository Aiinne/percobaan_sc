...
SETTINGS
*/
botName = "Rizki Bot" // NAMA BOT
ownerName = "Rizky Ganz" // NAMA OWNER
...
cr = "*_Rizki_*" // FAKE REPLY
const ownerNumber = "6281213988905@s.whatsapp.net" // NOMOR OWNER
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:RIzkyGanz\n' // NAMA OWNER
            + 'ORG:kontol;\n' // NAMA BOT
            + 'TEL;type=CELL;type=VOICE;waid=6281213988905:+6281213988905\n' // NOMOR OWNER
            + 'END:VCARD'
/*
SETTINGS
*/
...
${a}SELAMAT ${ucapan.data.result} ${pushname}${a}
